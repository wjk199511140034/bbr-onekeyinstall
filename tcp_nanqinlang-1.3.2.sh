...
install_image(){
	...
	[[ ! -f kernel-ml-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/CentOS-kernel/kernel-ml-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
install_devel(){
	...
	[[ ! -f kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/CentOS-kernel/kernel-ml-devel-4.12.10-1.el${bit}.elrepo.x86_64.rpm
...
install_headers(){
	...
	[[ ! -f kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/CentOS-kernel/kernel-ml-headers-4.12.10-1.el${bit}.elrepo.x86_64.rpm
