...
# for Debian 7
	...
	if [[ "`grep -oE  "[0-9.]+" /etc/issue`" = "7" ]]; then
		mv /etc/apt/sources.list /etc/apt/sources.list.backup
		wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/sources.list/hk.sources.list && mv hk.sources.list /etc/apt/sources.list
...
compiler(){
	...
	if [[ ! -z "${ver_4_13}" ]]; then
		wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/general/General/Debian/source/kernel-v4.13/tcp_nanqinlang.c
	else
		wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/general/General/Debian/source/kernel-v4.12andbelow/tcp_nanqinlang.c
	fi
	...
	if [[ "`grep -oE  "[0-9.]+" /etc/issue`" = "9" ]]; then
		wget -O Makefile https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/general/Makefile/Makefile-Debian9
	else
		wget -O Makefile https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/general/Makefile/Makefile-Debian7or8
	fi
