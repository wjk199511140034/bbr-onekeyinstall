...
config(){
	...
	[[ ! -f redirect.sh ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/lkl-haproxy/requirement/redirect.sh
...
check-all(){
	...
	# check lkl-mod
	[[ ! -f tcp_nanqinlang.so ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/lkl-haproxy/mod/tcp_nanqinlang.so
	[[ ! -f tcp_nanqinlang.so ]] && echo -e "${Error} download lkl.mod failed, please check !" && exit 1

	# check lkl-load
	[[ ! -f load.sh ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/lkl-haproxy/requirement/load.sh
	...
	# check selfstart
	[[ ! -f start.sh ]] && wget https://raw.githubusercontent.com/wjk199511140034/bbr-onekeyinstall/master/lkl-haproxy/requirement/start.sh
